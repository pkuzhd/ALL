...
void warrior::fight(int time)
{
	for (int city_num = 1; city_num <= city::number; ++city_num)
	{
		...
		//int x = first->weapon_num[SWORD] + first->weapon_num[BOMB] + first->weapon_num[ARROW];
		//int y = second->weapon_num[SWORD] + second->weapon_num[BOMB] + second->weapon_num[ARROW];
		//
		//for (int i = 0, j = 0; i < x || j < y;) // 激动人心的打架时间
		//{
		//	int flag = 0;
		//	if (i < first->weapon_num[SWORD])
		//	{
		//		second->hp_left -= force[first->kind] * 2 / 10;
		//		if (force[first->kind] * 2 / 10 == 0)
		//			++flag;
		//	}
		//	else if (i < first->weapon_num[SWORD] + first->weapon_num[BOMB])
		//	{
		//		int temp = force[first->kind] * 4 / 10;
		//		second->hp_left -= temp;
		//		if (first->kind != NINJA)
		//			first->hp_left -= temp / 2;
		//		int idx = i - first->weapon_num[SWORD];
		//		delete first->wp[BOMB][first->weapon_num[BOMB] - 1 - idx];
		//		first->wp[BOMB][first->weapon_num[BOMB] - 1 - idx] = NULL;
		//		++i;
		//	}
		//	else if (i < first->weapon_num[SWORD] + first->weapon_num[BOMB] + first->weapon_num[ARROW])
		//	{
		//		second->hp_left -= force[first->kind] * 3 / 10;
		//		int idx = i - first->weapon_num[SWORD] - first->weapon_num[BOMB];
		//		if (first->wp[ARROW][idx]->used)
		//		{
		//			delete first->wp[ARROW][idx];
		//			first->wp[ARROW][idx] = NULL;
		//			++i;
		//		}
		//		else
		//		{
		//			first->wp[ARROW][idx]->used = true;
		//		}
		//	}
		//	else
		//		++flag;
		...
		//	if (j < second->weapon_num[SWORD])
		//	{
		//		first->hp_left -= force[second->kind] * 2 / 10;
		//		if (force[second->kind] * 2 / 10 == 0)
		//			++flag;
		//	}
		//	else if (j < second->weapon_num[SWORD] + second->weapon_num[BOMB])
		//	{
		//		int temp = force[second->kind] * 4 / 10;
		//		first->hp_left -= temp;
		//		if (second->kind != NINJA)
		//			second->hp_left -= temp / 2;
		//		int idx = j - second->weapon_num[SWORD];
		//		delete second->wp[BOMB][second->weapon_num[BOMB] - 1 - idx];
		//		second->wp[BOMB][second->weapon_num[BOMB] - 1 - idx] = NULL;
		//		++j;
		//	}
		//	else if (j < second->weapon_num[SWORD] + second->weapon_num[BOMB] + second->weapon_num[ARROW])
		//	{
		//		first->hp_left -= force[second->kind] * 3 / 10;
		//		int idx = j - second->weapon_num[SWORD] - second->weapon_num[BOMB];
		//		if (second->wp[ARROW][idx]->used)
		//		{
		//			delete second->wp[ARROW][idx];
		//			second->wp[ARROW][idx] = NULL;
		//			++j;
		//		}
		//		else
		//		{
		//			second->wp[ARROW][idx]->used = true;
		//		}
		//	}
		//	else
		//		++flag;
